...
from pgslocusflows.build_TAD_map_flow import BuildTADMapFlow #modified the directory name from pgsflows to pgslocusflows
#from pgsflows.modeling_structure_flow import ModelingStructureFlow
from pgslocusflows.modeling_structure_flow import ModelingStructureFlow
#ht_off from pgsflows.report_flow import ReportFlow
...
# input validation
	...
	def workflow(self):
		...
		build_task_config['source_dir'] = build_task_config['source_dir'] + "/pgslocusflows/script" 
...
#		elif self.input_config['input'].has_key('prob_sparse_file') :
#			build_TAD_map_task = None
#			probMat = self.input_config['input']['prob_sparse_file']
		else :
		...
		modeling_structure_task = "locus_3D"
		self.addWorkflowTask(modeling_structure_task, modeling_structure_wf, dependencies=build_TAD_map_task)
		
		###############################################################
		# ReportFlow
		###############################################################
#ht_turn_off		report_task_config = modeling_task_config
		
#ht_turn_off		report_wf = ReportFlow(report_task_config)
#ht_turn_off		report_task = "report_task"
#ht_turn_off		self.addWorkflowTask(report_task, report_wf, dependencies=modeling_structure_task)
