...
import argparse
from alab.analysis import locusStructuresummary
...
if __name__=='__main__':
	...
	##################################################
	print args.theta
	s = locusStructuresummary(target=args.struct_dir, usegrp=args.theta, nstruct=int(args.nstruct) )
	...
	violfrac = s.totalViolations.mean()/s.totalRestraints.mean()
        if numpy.isnan(violfrac):
		violfrac = 0.0
